...
- **D4 冬日风落地页**：把 `首页文件/home.html` 的报刊式首页移植为 Next.js 入口页。
- README 全量改写为 GGZERO（当前仅 NOTICE + 本文件已是新身份）。
...
`9332865` 导入底座 → `6893eda` P0 跑通 → `d62357a` P1 改名 → `40afe15` P3a 主题引擎 → `5be6599` P3b 可上传主题。
（本地 git，未 push。）
