...
var auditedManagementWriteRoutes = map[string]struct{}{
	...
	"POST /api/v1/image/records":                                                     {},
	"DELETE /api/v1/image/records/:id":                                                {},
	...
	"POST /api/v1/subscription/admin/bind":                                           {},
	"POST /api/v1/subscription/admin/plans/create":                                   {},
	"POST /api/v1/subscription/admin/plans/update":                                   {},
	"DELETE /api/v1/subscription/admin/plans/delete/:id":                             {},
	...
	"POST /api/v1/user/oauth/github/bind":                                            {},
	"POST /api/v1/user/oauth/github/unbind":                                          {},
	"POST /api/v1/admin/2fa/disable/:id":                                             {},
	"POST /api/v1/wallet/stripe/topup":                                               {},
	"POST /api/v1/update":                                                            {},
