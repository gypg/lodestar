...
Ported from new-api's TopUp order model, adapted to Lodestar float-USD balance:
...
type PaymentOrder struct {
	...
	AmountUSD    float64 `json:"amount_usd" gorm:"type:double precision;not null"` // credit added to balance on success
	Money        float64 `json:"money" gorm:"type:double precision"`               // amount actually paid (gateway currency)
