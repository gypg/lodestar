...
<img src="web/public/logo.svg" alt="GGZERO" width="110" height="110">
...
GGZERO 是一个**完全属于自己**的 LLM 网关 / 中转站：
...
> GGZERO 衍生自 **octopus**（及其 `lingyuins/octopus` fork，贡献了多站聚合 hub），遵循 **AGPL v3** 并保留上游署名，见 [`NOTICE.md`](NOTICE.md)。
> 在其基础上新增了 GGZERO 的核心差异化——**每用户可上传 / 可切换的主题系统** 与 **冬日风落地页**。
